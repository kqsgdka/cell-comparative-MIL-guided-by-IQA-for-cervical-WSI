...
Version: V1.0.0
Author: kanglanlan 
Date: 2025-11-07 13:37:01
LastEditors: kanglanlan 
LastEditTime: 2025-11-07 13:52:59
FilePath: nystrom_attention.py
...
class NystromAttention(nn.Module):
    ...
    def forward(self, x, mask = None, return_attn = False):
        ...
        l = ceil(n / m)
        # print('l的值是多少：', l)
        # print('q的值是多少：', q.shape)
        # print('k的值是多少：', k.shape)
        # print('v的值是多少：', v.shape)
        # print(n, m, l)
