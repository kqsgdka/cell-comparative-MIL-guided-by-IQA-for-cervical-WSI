...
LastEditTime: 2025-08-03 20:08:35
FilePath: dataset_wrapper.py
...
class DataSetWrapper(object):
    ...
    def get_data_loaders(self):
        ...
        train_dataset = Dataset(csv_file='simclr/all_patches.csv', transform=SimCLRDataTransform(data_augment))
